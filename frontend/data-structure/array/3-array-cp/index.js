...
console.log(mostWordsFound(["Andi suka bermain bola", "Saya sedang belajar struktur data", "Terima kasih"]));
console.log(mostWordsFound(["Andi suka bermain bola", "Budi suka bermain basket", "Terima kasih"]));
module.exports = {
